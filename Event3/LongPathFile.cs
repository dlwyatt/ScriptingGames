        public static FileSecurity GetDacl(string path)
        {
            ...
            fileSec.SetSecurityDescriptorBinaryForm(bytes, AccessControlSections.Access);

            return fileSec;
        }

        public static void SetDacl(string path, FileSecurity securityDescriptor)
        {
            string normalizedPath = LongPathCommon.NormalizeLongPath(path);
